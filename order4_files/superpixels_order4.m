function superpixels_order4()

r = randi([1 255],1,1000);
g = randi([1 255],1,1000);
b = randi([1 255],1,1000);

segmentFileMat = load(strcat('order4/8068.mat'));
color_index=1;
superpixels = segmentFileMat.superpixels_o4;

superpixels_o5 = zeros(size(superpixels,1),size(superpixels,2));
segmentedImage = zeros(size(superpixels,1),size(superpixels,2),3);

fid = fopen('order4_clusters/clusters_o4_8068.txt');
...
matFileName = '../order5_files/order5/8068.mat';
save(matFileName, 'superpixels_o5');
