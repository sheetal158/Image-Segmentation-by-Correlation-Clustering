function superpixels_order5()

r = randi([1 255],1,1000);
g = randi([1 255],1,1000);
b = randi([1 255],1,1000);

segmentFileMat = load(strcat('order5/8068.mat'));
color_index=1;
superpixels = segmentFileMat.superpixels_o5;

superpixels_o6 = zeros(size(superpixels,1),size(superpixels,2));
segmentedImage = zeros(size(superpixels,1),size(superpixels,2),3);

fid = fopen('order5_clusters/clusters_o5_8068.txt');
...
matFileName = '../order6_files/order6/8068.mat';
save(matFileName, 'superpixels_o6');
