function superpixels_order3()

r = randi([1 255],1,1000);
g = randi([1 255],1,1000);
b = randi([1 255],1,1000);

segmentFileMat = load(strcat('order3/8068.mat'));
color_index=1;
superpixels = segmentFileMat.superpixels_o3;

superpixels_o4 = zeros(size(superpixels,1),size(superpixels,2));
segmentedImage = zeros(size(superpixels,1),size(superpixels,2),3);

fid = fopen('order3_clusters/clusters_o3_8068.txt');
...
matFileName = '../order4_files/order4/8068.mat';
save(matFileName, 'superpixels_o4');
